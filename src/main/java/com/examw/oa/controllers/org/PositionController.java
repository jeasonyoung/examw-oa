...
public class PositionController {
	...
	public Json delete(String id){
		...
		try {
			this.positionService.delete(id.split("\\|"));
	...
	@ResponseBody
	public DataGrid<PositionInfo> datagrid(PositionInfo info){
		return this.positionService.datagrid(info);
	}
	/**
	 * 初始化数据。
	 * @return
