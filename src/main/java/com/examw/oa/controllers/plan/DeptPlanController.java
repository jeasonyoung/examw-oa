...
public class DeptPlanController {
	 ...
	 * @return
	 */
	@RequiresPermissions({ModuleConstant.PLAN_DEPT + ":" + Right.VIEW})
	 ...
	 * 编辑页面。
	 */
	@RequiresPermissions({ModuleConstant.PLAN_DEPT + ":" + Right.UPDATE})
	 ...
	 * 结果
	 */
	@RequiresPermissions({ModuleConstant.PLAN_DEPT + ":" + Right.DELETE})
	...
	public String menberEdit(String deptId,Model model){
		if(logger.isDebugEnabled()) logger.debug("加载部门计划成员编辑页面...");
